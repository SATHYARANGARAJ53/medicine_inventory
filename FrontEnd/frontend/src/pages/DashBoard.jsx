...
export default function DashBoard() {
  ...
  const [clinicid, setClinicid] = useState(null);  // Store globally for this component
            ...
            <tbody>
              {medicines.map((medicine, index) => (
                <tr key={index}>
                  ...
                  <td className="group">
                    <input type="number" className="form-control" min="1" max={medicine.quantity_available} />
